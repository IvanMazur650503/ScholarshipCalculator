...
// Project_UNI.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CProject_UNIApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CProject_UNIApp

CProject_UNIApp::CProject_UNIApp()
{
...
// Единственный объект CProject_UNIApp

CProject_UNIApp theApp;


// инициализация CProject_UNIApp

BOOL CProject_UNIApp::InitInstance()
{
